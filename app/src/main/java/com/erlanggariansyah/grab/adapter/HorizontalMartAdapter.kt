...
class HorizontalMartAdapter(private val horizontalMenuItems: ArrayList<HorizontalMenuItem>): RecyclerView.Adapter<HorizontalMartAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder = ViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.recycler_horizontal_mart_item, parent, false))
